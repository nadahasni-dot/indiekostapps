...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="admin-settings-profil.php">
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="admin-settings-rubah-password.php">
              ...
              <div class="card-body">
                ...
                <?php 
                  ...
                  if(isset($_SESSION['akun_id'])){
                      ...
                      $query = "SELECT * FROM info_kost, pengguna WHERE info_kost.id_pengguna = $id_pengguna AND pengguna.id_pengguna = $id_pengguna";
                      $result = mysqli_query($conn, $query);
                ...
                <div class="container-fluid pr-3">
                  ...
                  ?>" alt="<?php echo $data['nama_kost']; ?>" class="img-thumbnail mx-auto d-block mb-3 rounded" width="300px">
                    ...
                    <table class="table">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $data['alamat_kost']; ?></td>
                        </tr>
                        <tr>
                          <td class="font-weight-bold" width="30%">Provinsi</td>
                          <td><?php echo $data['provinsi_kost']; ?></td>
                        </tr>
                        <tr>
                          <td class="font-weight-bold" width="30%">Kota</td>
                          <td><?php echo $data['kota_kost']; ?></td>
                        </tr>
                        <tr>
                          <td class="font-weight-bold" width="30%">Telepon</td>
                          <td><?php echo $data['no_kost']; ?></td>
                        </tr>
                        <tr>
                          <td class="font-weight-bold" width="30%">Email</td>
                          <td><?php echo $data['email_kost']; ?></td>
                        </tr>
                        <tr>
                          <td class="font-weight-bold" width="30%">Deskripsi Kost</td>
                          <td><?php echo $data['deskripsi_kost']; ?></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                  <button class="btn btn-success btn-block edit_data" id="<?php echo $data['id_kost']; ?>">Edit Info Kost</button>
                </div>
                <?php
                    }
                  }
